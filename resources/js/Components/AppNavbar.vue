    ...
    <header class="bg-white py-4 shadow-md w-full">
        <div class="container mx-auto px-5 flex justify-between items-center">
            ...
            <nav class="hidden md:flex space-x-6 items-center">
                ...
                <a href="#" class="text-gray-600 font-semibold hover:text-blue-500 transition-colors duration-300">About</a> -->
                <Link href="/"
                class="text-gray-600 font-semibold hover:text-blue-500 transition-colors duration-300" > Home 
                </Link>
                ...
                <Link
                :href="route('aboutUs')"
                class="text-gray-600 font-semibold hover:text-blue-500 transition-colors duration-300"> About 
                </Link>
